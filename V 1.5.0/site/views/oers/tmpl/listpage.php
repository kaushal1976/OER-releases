...
<tr>
	<td colspan="4">
		...
		<input type="text" size="40" maxlength="250" name="search" id="search" value="<?php echo htmlspecialchars($this->lists['search']);?>" class="inputbox" onchange="document.adminForm.submit();" />
